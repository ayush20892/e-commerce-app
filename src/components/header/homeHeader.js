  ...
  return(
    ...
    <nav>
      <div className="ham-brand">
        <div onClick style={{top: "-0.3rem"}} className="ham-icon" >
          &#9776;
        </div>
        ...
        <div class="nav-pills">
          <h5 onClick={() => navigate('/categories/men')} class="nav-item">MEN</h5>
          <h5 onClick={() => navigate('/categories/women')} class="nav-item">WOMEN</h5>
          <h5 onClick={() => navigate('/categories/gadget')} class="nav-item">GADGETS</h5>
        </div>
      </div>
